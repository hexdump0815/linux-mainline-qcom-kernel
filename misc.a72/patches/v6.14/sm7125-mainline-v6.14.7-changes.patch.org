created via: https://github.com/sm7125-mainline/linux/compare/134876e3415694dfe94fa44678cf853434ea480f...ac499943aba5f6a7dd56d6a88952b939d9f13f6a.diff

from the linux-6.14.7 branch
...
index 140b0b2abfb555..4627e6f3f8bf48 100644
--- a/arch/arm64/boot/dts/qcom/Makefile
+++ b/arch/arm64/boot/dts/qcom/Makefile
@@ -249,8 +249,10 @@ dtb-$(CONFIG_ARCH_QCOM)	+= sm6125-sony-xperia-seine-pdx201.dtb
...
index 87c432c12a240f..46835d4e2c2c0c 100644
...
index 2aa00769cf09da..c0b56b84a82511 100644
...
index edffb7737a97b2..237a7456da16d2 100644
...
index d7469c565d1db8..c12babfdd3a15e 100644
--- a/drivers/gpu/drm/panel/Kconfig
+++ b/drivers/gpu/drm/panel/Kconfig
@@ -135,6 +135,17 @@ config DRM_PANEL_FEIYANG_FY07024DI26A30D
...
+
 config DRM_PANEL_DSI_CM
 	...
 	depends on OF
@@ -497,6 +508,14 @@ config DRM_PANEL_NOVATEK_NT36672E
...
index 7dcf72646cacff..2f37d1a5f2bb89 100644
...
new file mode 100644
index 00000000000000..591f8d9e866d17
--- /dev/null
...
new file mode 100644
index 00000000000000..68ad43d9cb5d07
--- /dev/null
...
index 13d135257e0601..8a8d0b45fe79df 100644
...
index 1a03de7fcfa66c..bb86898f9c17ed 100644
--- a/drivers/input/touchscreen/Kconfig
+++ b/drivers/input/touchscreen/Kconfig
@@ -665,6 +665,19 @@ config TOUCHSCREEN_IMAGIS
 	  To compile this driver as a module, choose M here: the
...
@@ -962,6 +975,19 @@ config TOUCHSCREEN_MX25
 	  To compile this driver as a module, choose M here: the
...
index 85ecb2aeefdbff..b6e05caa27af2e 100644
--- a/drivers/media/i2c/Kconfig
+++ b/drivers/media/i2c/Kconfig
@@ -386,6 +386,15 @@ config VIDEO_OV13B10
...
+
 config VIDEO_OV2640
 	...
 	help
@@ -685,12 +694,30 @@ config VIDEO_S5K5BAF
...
+
 config VIDEO_VGXY61
 	...
 	select V4L2_CCI_I2C
@@ -782,6 +809,18 @@ config VIDEO_DW9768
...
index fbb988bd067a1b..2f677f5300d57b 100644
...
@@ -86,6 +87,7 @@ obj-$(CONFIG_VIDEO_OV08D10) += ov08d10.o
...
@@ -119,7 +121,9 @@ obj-$(CONFIG_VIDEO_RDACM21) += rdacm21.o
...
index e6704d01824815..86e63a2ef26a21 100644
...
index f341f7b7fd8ab5..005ea075f79d6e 100644
...
+
 static void csiphy_hw_version_read(struct csiphy_device *csiphy,
 				   struct device *dev)
 {
@@ -505,6 +635,10 @@ static void csiphy_gen2_config_lanes(struct csiphy_device *csiphy,
 	u32 val;
...
@@ -561,6 +695,7 @@ static bool csiphy_is_gen2(u32 version)
 	bool ret = false;
...
index 95f6a1ac7eaf53..386e12fb79798a 100644
...
+	case CAMSS_7180:
 	...
 	case CAMSS_8x96:
 	case CAMSS_8250:
@@ -1694,6 +1695,7 @@ static int vfe_bpl_align(struct vfe_device *vfe)
 	int ret = 8;
...
index a85e9df0f301a9..1d011d4de038fc 100644
--- a/drivers/media/platform/qcom/camss/camss.c
+++ b/drivers/media/platform/qcom/camss/camss.c
@@ -1266,6 +1266,267 @@ static const struct resources_icc icc_res_sm8250[] = {
 	},
 };
...
+
 static const struct camss_subdev_resources csiphy_res_7280[] = {
 	/* CSIPHY0 */
 	{
@@ -2938,6 +3199,20 @@ static const struct camss_resources sc8280xp_resources = {
...
+
 static const struct camss_resources sc7280_resources = {
 	.version = CAMSS_7280,
 	.pd_name = "top",
@@ -2956,6 +3231,7 @@ static const struct of_device_id camss_dt_match[] = {
...
index 9a046eea334fa1..4b71f604f13ba3 100644
...
index 7b18358f194a70..905565c6fe8617 100644
...
index b55cc48a4c86f8..0c293c4633864a 100644
...
index 154ca5beb47160..c87989dc0add60 100644
...
+	&cdsp_root_pd,
 	...
 	&mpss_wlan_pd,
 	NULL,
@@ -553,6 +554,7 @@ static const struct of_device_id qcom_pdm_domains[] __maybe_unused = {
...
index 9afe701b2a1b64..070400030cb87e 100644
