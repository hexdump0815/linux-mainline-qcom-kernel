created via: https://github.com/map220v/sm7125-mainline/compare/3d7cb6b04c3f3115719235cc6866b10326de34cd...97744a6d9de46fe47f780de7213573201df15c69.diff

diff --git a/arch/arm64/boot/dts/qcom/Makefile b/arch/arm64/boot/dts/qcom/Makefile
index 2f8aec2cc6db63..e21471be4ec63b 100644
--- a/arch/arm64/boot/dts/qcom/Makefile
+++ b/arch/arm64/boot/dts/qcom/Makefile
@@ -112,6 +112,8 @@ dtb-$(CONFIG_ARCH_QCOM)	+= sdm850-lenovo-yoga-c630.dtb
...
index 3163660fa8e290..9a727d9865beb9 100644
--- a/drivers/firmware/qcom_scm.c
+++ b/drivers/firmware/qcom_scm.c
@@ -858,8 +858,9 @@ int qcom_scm_assign_mem(phys_addr_t mem_addr, size_t mem_sz,
...
index 42ed9a3c490551..d9d700fa489dd7 100644
...
@@ -1759,6 +1827,8 @@ static u32 a618_get_speed_bin(u32 fuse)
 		return 1;
 	else if (fuse == 174)
 		return 2;
+	else if (fuse == 159)
...
index 8706bcdd1472e6..a8fc8d3a6c14de 100644
...
+		.hwcg = a615_hwcg,
 		...
 		.revn = 630,
@@ -355,6 +357,10 @@ MODULE_FIRMWARE("qcom/a530_zap.mdt");
...
index ab3b5ef80332db..4ac37925d4afac 100644
...
index 400ebceb56bb66..5faf207f023d6f 100644
--- a/drivers/gpu/drm/msm/disp/dpu1/dpu_hw_catalog.c
+++ b/drivers/gpu/drm/msm/disp/dpu1/dpu_hw_catalog.c
@@ -315,6 +315,19 @@ static const struct dpu_caps sc7180_dpu_caps = {
...
@@ -469,6 +482,25 @@ static const struct dpu_mdp_cfg sc8180x_mdp[] = {
 	},
 };
...
+
 static const struct dpu_mdp_cfg sm8250_mdp[] = {
 	{
 	.name = "top_0", .id = MDP_TOP,
@@ -617,6 +649,27 @@ static const struct dpu_ctl_cfg sc7180_ctl[] = {
 	},
 };
...
+
 static const struct dpu_ctl_cfg sm8150_ctl[] = {
 	{
 	.name = "ctl_0", .id = CTL_0,
@@ -846,6 +899,20 @@ static const struct dpu_sspp_cfg sc7180_sspp[] = {
...
@@ -1151,6 +1218,15 @@ static struct dpu_pingpong_cfg sc7180_pp[] = {
...
+
 static const struct dpu_pingpong_cfg sm8150_pp[] = {
 	PP_BLK_TE("pingpong_0", PINGPONG_0, 0x70000, MERGE_3D_0, sdm845_pp_sblk_te,
 			DPU_IRQ_IDX(MDP_SSPP_TOP0_INTR, 8),
@@ -1582,6 +1658,34 @@ static const struct dpu_perf_cfg sc7180_perf_data = {
...
@@ -1812,6 +1916,37 @@ static void sc7180_cfg_init(struct dpu_mdss_cfg *dpu_cfg)
 	};
 }
...
+
  ...
  * and instance counts.
@@ -1975,7 +2110,9 @@ static const struct dpu_mdss_hw_cfg_handler cfg_handler[] = {
...
index 38799effd00ad8..25bbb6806ba6ff 100644
--- a/drivers/gpu/drm/panel/Kconfig
+++ b/drivers/gpu/drm/panel/Kconfig
@@ -518,6 +518,16 @@ config DRM_PANEL_SAMSUNG_S6E88A0_AMS452EF01
 	select DRM_MIPI_DSI
...
index 42a7ab54234b0b..55ef2af4d1863b 100644
--- a/drivers/gpu/drm/panel/Makefile
+++ b/drivers/gpu/drm/panel/Makefile
@@ -52,6 +52,7 @@ obj-$(CONFIG_DRM_PANEL_SAMSUNG_S6E63M0) += panel-samsung-s6e63m0.o
...
index 6ac402ea58fbe1..bcbe3c5f2b5f57 100644
...
@@ -554,6 +554,7 @@ static int geni_i2c_gpi(struct geni_i2c_dev *gi2c, struct i2c_msg *msg,
...
index 877eca12580376..4c61023151f8cf 100644
--- a/drivers/media/platform/qcom/venus/core.c
+++ b/drivers/media/platform/qcom/venus/core.c
@@ -752,6 +752,53 @@ static const struct venus_resources sc7180_res = {
...
+
 static const struct freq_tbl sm8250_freq_table[] = {
 	{ 0, 444000000 },
 	{ 0, 366000000 },
@@ -866,6 +913,7 @@ static const struct of_device_id venus_dt_match[] = {
...
index c7309e981bfb5c..3ab9805ad0ad19 100644
--- a/drivers/phy/qualcomm/phy-qcom-qmp.c
+++ b/drivers/phy/qualcomm/phy-qcom-qmp.c
@@ -1624,6 +1624,36 @@ static const struct qmp_phy_init_tbl msm8998_usb3_pcs_tbl[] = {
...
@@ -3967,6 +3997,31 @@ static const struct qmp_phy_cfg sm8150_ufsphy_cfg = {
...
+
 static const struct qmp_phy_cfg sm8150_usb3phy_cfg = {
 	.type			= PHY_TYPE_USB3,
 	.nlanes			= 1,
@@ -6092,6 +6147,9 @@ static const struct of_device_id qcom_qmp_phy_of_match_table[] = {
 	}, {
...
index 6ae39c5653b1c3..cb01c42fa07408 100644
--- a/drivers/remoteproc/qcom_q6v5_pas.c
+++ b/drivers/remoteproc/qcom_q6v5_pas.c
@@ -567,6 +567,23 @@ static const struct adsp_data sm6350_adsp_resource = {
 	.ssctl_id = 0x14,
 };
...
+
 static const struct adsp_data sm8150_adsp_resource = {
 		.crash_reason_smem = 423,
 		.firmware_name = "adsp.mdt",
@@ -672,6 +689,23 @@ static const struct adsp_data sm6350_cdsp_resource = {
 	.ssctl_id = 0x17,
 };
...
+
 static const struct adsp_data sm8150_cdsp_resource = {
 	.crash_reason_smem = 601,
 	.firmware_name = "cdsp.mdt",
@@ -902,6 +936,8 @@ static const struct of_device_id adsp_of_match[] = {
...
index cee579a267a6b5..82d123e12084ac 100644
...
index e62a3da16aed31..5fa9e3eee8c3c9 100644
...
index 6e1184c8b672a6..52c6e6d83c0731 100644
