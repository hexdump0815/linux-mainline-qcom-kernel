created via: https://github.com/TravMurav/linux/compare/ffc253263a1375a65fa6c9f62a893e9767fbebfa...90f2e5637bcf7a93dc3a1618a7a9a2763f40c8ca.diff
...
index a79c0f2e18799c..0ddf6f3a8f0410 100644
...
index d615b6c55b8919..ebea3ea2f927f0 100644
...
index 57c5f35dfcc51c..27a4d32530dfcd 100644
...
@@ -134,12 +136,29 @@ static int sc7180_init(struct snd_soc_pcm_runtime *rtd)
 	return 0;
 }
...
@@ -166,30 +217,67 @@ static int sc7180_snd_startup(struct snd_pcm_substream *substream)
...
+	case VA_CODEC_DMA_TX_0:
 	...
 	default:
 		dev_err(rtd->dev, "%s: invalid dai id 0x%x\n", __func__,
@@ -247,6 +335,43 @@ static void sc7180_snd_shutdown(struct snd_pcm_substream *substream)
 	}
 }
...
+
 ...
 {
 	struct snd_soc_dai *cpu_dai = asoc_rtd_to_cpu(rtd, 0);
@@ -295,11 +420,30 @@ static int sc7180_adau7002_snd_startup(struct snd_pcm_substream *substream)
 	return 0;
 }
...
@@ -355,7 +499,7 @@ static int sc7180_snd_platform_probe(struct platform_device *pdev)
...
@@ -391,6 +535,8 @@ static int sc7180_snd_platform_probe(struct platform_device *pdev)
 		no_headphone = true;
...
@@ -401,6 +547,12 @@ static int sc7180_snd_platform_probe(struct platform_device *pdev)
 		if (no_headphone) {
...
@@ -413,6 +565,7 @@ static int sc7180_snd_platform_probe(struct platform_device *pdev)
