created via: https://github.com/TravMurav/linux/compare/0dd3ee31125508cd67f7e7172247f05b7fd1753a...e9ef149c8cb55b4cf2ace5ffdd3b8fff0934f9e7.diff

diff --git a/Documentation/devicetree/bindings/pinctrl/qcom,sc7280-lpass-lpi-pinctrl.yaml b/Documentation/devicetree/bindings/pinctrl/qcom,sc7280-lpass-lpi-pinctrl.yaml
index 00c5a00e35fce2..20facc851d8f37 100644
--- a/Documentation/devicetree/bindings/pinctrl/qcom,sc7280-lpass-lpi-pinctrl.yaml
+++ b/Documentation/devicetree/bindings/pinctrl/qcom,sc7280-lpass-lpi-pinctrl.yaml
@@ -15,11 +15,23 @@ description:
 
 properties:
   compatible:
-    const: qcom,sc7280-lpass-lpi-pinctrl
+    enum:
+      - qcom,sc7180-lpass-lpi-pinctrl
...
index 00000000000000..3fc6dea7fa5cb1
--- /dev/null
...
index dbb48934d49950..f37d33539b661a 100644
...
+	reg_cam_3p3: camera-regulator {
+		compatible = "regulator-fixed";
+		regulator-name = "cam_3p3";
...
+		regulator-boot-on;
+
+		pinctrl-0 = <&reg_camera_en_default>;
+		pinctrl-names = "default";
+	};
+
...
+	reg_hub_3p3: hub-regulator {
+		compatible = "regulator-fixed";
+		regulator-name = "hub_3p3";
+		regulator-min-microvolt = <3300000>;
+		regulator-max-microvolt = <3300000>;
+
+		/*
+		 * NOTE: This load switch can also be controlled by
+		 * the EC so deasserting this gpio doesn't always cut
+		 * the power.
+		 */
...
+
+		/*
+		 * HACK: The camera regulator is not actually
+		 * the supplier for the hub regulator. It's added
+		 * here for the purpose of controlling the camera
+		 * power in suspend since as of now there is no
+		 * nice way to represent on-board usb devices.
+		 *
+		 * This allows us to disable the camera in suspend
+		 * at least as long as no wakeup source device is
+		 * conected.
+		 */
+		vin-supply = <&reg_cam_3p3>;
+
+		pinctrl-0 = <&reg_hub_en_default>;
+		pinctrl-names = "default";
+	};
+
...
+		compatible = "regulator-fixed";
+		regulator-name = "ts_3p3";
+		regulator-min-microvolt = <3300000>;
+		regulator-max-microvolt = <3300000>;
+
+		/*
+		 * There is no touchscreen on the device
+		 * but this rail still exists even if disabled
+		 * on reset. This just ensures we disable this
+		 * gpio and the rail switch if it's ever enabled.
+		 */
+
+		gpio = <&tlmm 4 GPIO_ACTIVE_HIGH>;
+		enable-active-high;
+
+		pinctrl-0 = <&reg_ts_en_default>;
+		pinctrl-names = "default";
+	};
+
 };
...
+		pinctrl-names = "default";
+
+		/* FIXME: This should be set by the firmware. */
+		acer,media-keys-on-top;
+
+		connector {
+			compatible = "usb-c-connector";
...
+	reg_camera_en_default: reg-camera-en-deault-state {
+		pins = "gpio3";
+		function = "gpio";
+		drive-strength = <2>;
+		bias-disable;
...
+	reg_hub_en_default: reg-hub-en-deault-state {
+		pins = "gpio5";
+		function = "gpio";
+		drive-strength = <16>;
+		bias-disable;
...
+	reg_ts_en_default: reg-ts-en-deault-state {
+		pins = "gpio4";
+		function = "gpio";
+		drive-strength = <2>;
+		bias-disable;
...
index 11f353d416b4d5..d4637637fa739a 100644
...
new file mode 100644
index 00000000000000..fb23ac988ed1ba
--- /dev/null
...
index fdb0fae88d1c58..29035daf21bc09 100644
...
index fe7267b3bff536..2cfe733e37dcc1 100644
--- a/drivers/gpu/drm/msm/disp/dpu1/dpu_kms.c
+++ b/drivers/gpu/drm/msm/disp/dpu1/dpu_kms.c
@@ -729,6 +729,8 @@ static int _dpu_kms_drm_obj_init(struct dpu_kms *dpu_kms)
...
@@ -756,21 +758,28 @@ static int _dpu_kms_drm_obj_init(struct dpu_kms *dpu_kms)
...
index 3eef5e025e12e0..fab7587fb12826 100644
--- a/drivers/gpu/drm/msm/disp/dpu1/dpu_plane.c
+++ b/drivers/gpu/drm/msm/disp/dpu1/dpu_plane.c
@@ -1457,7 +1457,7 @@ struct drm_plane *dpu_plane_init(struct drm_device *dev,
...
index 99156217c6a5a0..997e5cb76ff977 100644
--- a/drivers/pinctrl/qcom/pinctrl-sc7280-lpass-lpi.c
+++ b/drivers/pinctrl/qcom/pinctrl-sc7280-lpass-lpi.c
@@ -144,6 +144,10 @@ static const struct lpi_pinctrl_variant_data sc7280_lpi_data = {
 };
...
index f21cb05815ec63..47d2ad14447bda 100644
...
index 58b56727803498..6049c87820c040 100644
...
new file mode 100644
index 00000000000000..845a11abf951d6
--- /dev/null
...
index b0320a74d5088f..437966f3555ea8 100644
--- a/sound/soc/qcom/sc7180.c
+++ b/sound/soc/qcom/sc7180.c
@@ -145,6 +145,7 @@ static int sc7180_qdsp_init(struct snd_soc_pcm_runtime *rtd)
...
@@ -276,6 +277,7 @@ static int sc7180_qdsp_snd_startup(struct snd_pcm_substream *substream)
...
@@ -361,6 +363,7 @@ static void sc7180_qdsp_snd_shutdown(struct snd_pcm_substream *substream)
