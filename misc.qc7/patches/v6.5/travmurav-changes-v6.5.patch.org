created via: https://github.com/TravMurav/linux/compare/2dde18cd1d8fac735875f2e4987f11817cc0bc2c...ece1866129a73ddb831f50098bb404dba3fa92c9.diff
...
index b637b4270f889b..f65c616e14b61b 100644
...
+			cpu { sound-dai = <&q6afedai PRIMARY_MI2S_TX>; };
+			platform { sound-dai = <&q6routing>; };
+			codec { sound-dai = <&alc5682 0>; };
+		};
+
+		dai-link-tertiary-rx {
...
+		};
+
+		dai-link-displayport-rx {
+			link-name = "DisplayPort Playback";
+			cpu { sound-dai = <&q6afedai DISPLAY_PORT_RX>;	};
+			platform { sound-dai = <&q6routing>; };
...
index a1c50be4ad9554..0146fb0036d448 100644
...
index 681637cf6c4aff..58fa62bb01de26 100644
...
index 06df931d8cad30..d3cb3229271a0f 100644
...
index 663a1c4238066e..388ce37dd8fb70 100644
...
index 9626a9ef78c233..e67045b5e8befb 100644
...
+	struct sm8250_snd_data *pdata = snd_soc_card_get_drvdata(card);
...
+			&pdata->hs_jack,
+			sc7180_jack_pins, ARRAY_SIZE(sc7180_jack_pins));
+
+	if (rval < 0) {
...
@@ -51,10 +149,43 @@ static int sm8250_snd_startup(struct snd_pcm_substream *substream)
...
+						     RT5682_PLL1_FREQ, SND_SOC_CLOCK_IN);
+			if (ret)
...
+		break;
 	case TERTIARY_MI2S_RX:
 		codec_dai_fmt |= SND_SOC_DAIFMT_NB_NF | SND_SOC_DAIFMT_I2S;
 		snd_soc_dai_set_sysclk(cpu_dai,
@@ -69,6 +200,35 @@ static int sm8250_snd_startup(struct snd_pcm_substream *substream)
 	return 0;
 }
...
+
 ...
 {
@@ -103,6 +263,7 @@ static int sm8250_snd_hw_free(struct snd_pcm_substream *substream)
...
@@ -122,6 +283,16 @@ static void sm8250_add_be_ops(struct snd_soc_card *card)
 	}
 }
...
+
 ...
 {
 	struct snd_soc_card *card;
@@ -140,6 +311,10 @@ static int sm8250_platform_probe(struct platform_device *pdev)
 		return -ENOMEM;
...
@@ -153,6 +328,7 @@ static int sm8250_platform_probe(struct platform_device *pdev)
