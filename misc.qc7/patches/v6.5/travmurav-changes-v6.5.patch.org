created via: https://github.com/TravMurav/linux/compare/2dde18cd1d8fac735875f2e4987f11817cc0bc2c...10a2c074dbe857a0ca46ea6fd21e741cd5d143c5.diff
...
index b637b4270f889b..644fd33a259728 100644
...
index 06df931d8cad30..8e712522d0c45b 100644
...
index 9626a9ef78c233..6345d27eabf27f 100644
...
@@ -51,10 +108,43 @@ static int sm8250_snd_startup(struct snd_pcm_substream *substream)
...
+		break;
 	case TERTIARY_MI2S_RX:
 		codec_dai_fmt |= SND_SOC_DAIFMT_NB_NF | SND_SOC_DAIFMT_I2S;
 		snd_soc_dai_set_sysclk(cpu_dai,
@@ -69,6 +159,35 @@ static int sm8250_snd_startup(struct snd_pcm_substream *substream)
 	return 0;
 }
...
+
 ...
 {
@@ -103,6 +222,7 @@ static int sm8250_snd_hw_free(struct snd_pcm_substream *substream)
...
@@ -153,6 +273,7 @@ static int sm8250_platform_probe(struct platform_device *pdev)
