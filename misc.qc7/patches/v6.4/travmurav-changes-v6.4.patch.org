created via: https://github.com/TravMurav/linux/compare/6995e2de6891c724bfeb2db33d7b87775f913ad1%E2%80%A6450cd30daaec642b7486ade4b131d224ffd5e959.diff

diff --git a/Documentation/devicetree/bindings/arm/qcom.yaml b/Documentation/devicetree/bindings/arm/qcom.yaml
index d9dd25695c3dde..d30ce938e303d7 100644
...
index d42c59572ace0f..ae4d29df135e4f 100644
...
index 00000000000000..bd957db5965b88
--- /dev/null
...
new file mode 100644
index 00000000000000..ee35a454dbf6f3
--- /dev/null
...
index 299ef5dc225ab3..ba76283b06f4b4 100644
...
index 1472e7f108311c..001cdfe3cbcece 100644
...
index a65be760d1a7c0..b93595894978d1 100644
...
new file mode 100644
index 00000000000000..af5486b4725187
--- /dev/null
...
index 01581f4d2c39c4..4d675b4c2ca541 100644
...
index 76551534f10dfe..08fa26ee52cddd 100644
...
@@ -325,27 +305,15 @@ static int __clk_rcg2_configure(struct clk_rcg2 *rcg, const struct freq_tbl *f,
...
@@ -1035,12 +1003,11 @@ static int clk_rcg2_shared_set_rate(struct clk_hw *hw, unsigned long rate,
 		return -EINVAL;
...
@@ -1064,11 +1031,6 @@ static int clk_rcg2_shared_enable(struct clk_hw *hw)
 	if (ret)
 		return ret;
...
-
 	...
 	if (ret)
 		return ret;
@@ -1079,12 +1041,13 @@ static int clk_rcg2_shared_enable(struct clk_hw *hw)
...
@@ -1102,52 +1065,17 @@ static void clk_rcg2_shared_disable(struct clk_hw *hw)
 	update_config(rcg);
...
index 4676cf2900dfdc..9c3f9a36ab1092 100644
...
index 0e7a68714e9e16..b018aafebbd3b0 100644
--- a/drivers/gpu/drm/msm/disp/dpu1/dpu_kms.c
+++ b/drivers/gpu/drm/msm/disp/dpu1/dpu_kms.c
@@ -710,6 +710,8 @@ static int _dpu_kms_drm_obj_init(struct dpu_kms *dpu_kms)
...
@@ -737,21 +739,28 @@ static int _dpu_kms_drm_obj_init(struct dpu_kms *dpu_kms)
...
index 14b5cfe3061139..12eba0ef8c34a2 100644
--- a/drivers/gpu/drm/msm/disp/dpu1/dpu_plane.c
+++ b/drivers/gpu/drm/msm/disp/dpu1/dpu_plane.c
@@ -1489,7 +1489,7 @@ struct drm_plane *dpu_plane_init(struct drm_device *dev,
...
index e23ddab2126eb1..a6f41865402e2b 100644
...
index e34d82b18a67b6..2b3769313a08f9 100644
...
index f65bfeca7ed6b9..2938368c21d694 100644
